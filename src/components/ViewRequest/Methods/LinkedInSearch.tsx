  ...
  return (
    <section>
      ...
      <Text id="linkedinSearchTitles">
        {props.data.linkedinSearchTitle1}
        {props.data.linkedinSearchTitle2}
        {props.data.linkedinSearchTitle3}
        {props.data.linkedinSearchTitle4}
      </Text>
      ...
      <Text id="linkedinSearchSkills">
        {props.data.linkedinSearchSkill1}
        {props.data.linkedinSearchSkill2}
        {props.data.linkedinSearchSkill3}
        {props.data.linkedinSearchSkill4}
      </Text>
      ...
      <Text id="linkedinSearchStudies">
        {props.data.linkedinSearchStudy1}
        {props.data.linkedinSearchStudy2}
        {props.data.linkedinSearchStudy3}
        {props.data.linkedinSearchStudy4}
      </Text>
      ...
      <Text id="linkedinSearchKeywords">
        {props.data.linkedinSearchKeyword1}
        {props.data.linkedinSearchKeyword2}
        {props.data.linkedinSearchKeyword3}
        {props.data.linkedinSearchKeyword4}
      </Text>

      <Label weight="semibold" htmlFor="linkedinSearchComments">
        Additional Comments/Info
      </Label>
      <Text id="linkedinSearchComments">
